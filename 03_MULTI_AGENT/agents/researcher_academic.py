...
@with_tags("academic_researcher")
@safe_node
async def academic_researcher_node(payload: dict) -> dict[str, Any]:
    ...
    return {
        "evidence": evidence,
        "messages": [AIMessage(content=f"[academic:{sq_id}] 收集 {len(evidence)} 条")],
    }
